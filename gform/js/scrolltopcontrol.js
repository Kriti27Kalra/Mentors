...
var scrolltotop = {
  ...
  controlHTML:
    '<i class="fa fa-angle-double-up btn-warning" style="border-radius:1px;color:#fff;padding:7px 10px 7px 10px;"></i>', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol"
